...
router.post('/type/:type/encode/:encode',async (req, res) => {
    ...
    <transaction xmlns="http://www.metrex.net/momex/transaction#"
        ...
        <momex:document momex:mime-type='${req.params.type}' momex:file-name='prescriptiondocument.png' pw:document-contains-rx="true" momex:mime-encoding="base64">${req.params.encode}  
                               </momex:document>
    </transaction>
  `;
