...
`;
    ...
    async function main(){
       ...
       */
      const uri = "mongodb+srv://canadadrugstore:Health4Ever!@jcd.77td5.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
    ...
    async function createListing( client, newListing){
      const result = await client.db("JCDDatabase").collection("PWDatabase")
